...
const LandingPage = () => {
    return (
        <div
            className={`${poppins.className} z-0 h-[50.063rem] mx-auto relative pt-24 w-full`}
        >
            <section className="relative w-full h-[75vh] sm:h-full overflow-hidden">
                <Image
                    fill
                    src={landinglast}
                    alt="img"
                ...
                <div className="absolute space-y-4 pb-16 z-0 inset-0 bg-black/50  flex text-center flex-col sm:px-10 px-5 md:px-50 justify-center items-center pt-26 ">
                    ...
                    >
                        Hire or get hired in one seamless platform built for
