...
const Popular = () => {
    return (
        <div
            className={` bg-gradient-to-r from-[#FFFFFF] to-[#FFE1D0] md:py-14 py-8 `}
        >
            <div className="max-w-7xl w-[95%] mx-auto">
                <div className="text-center space-y-2 py-2">
                    ...
                    <p
                        className={`text-[#003271] text-sm font-medium ${inter.className}`}
                    >
                ...
                <div
                    data-aos="fade-right"
                    className="hidden md:grid md:grid-cols-3 px-3 py-3  gap-3 lg:grid-cols-4"
                >
                    {items.map((item) => (
                ...
                <div className="flex overflow-x-scroll gap-3 md:hidden py-3 ">
                    {items.map((item) => (
                ...
                <div className="flex px-3 justify-center gap-4 items-center">
                    <div className="md:flex py-6 md:py-0 space-y-2 sm:space-y-0  justify-center gap-2">
                        <h1
                            className={`${poppins.className} text-xs sm:text-sm md:text-base text-[#737380]`}
                        >
