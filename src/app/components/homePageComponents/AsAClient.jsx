...
const facts = [
  {
    ...
    textwo:
      " From home repairs to event setups, find verified experts ready to deliver quality work fast, transparent, and on your term",
  },
  {
    id: 2,
    head: "B",
    ...
    textwo:
      "Join a growing network of verified providers, attract the right clients, and manage your bookings — all in one dashboard. ",
  },
];
const AsAClient = () => {
  return (
    <div className="bg-gradient-to-r md:flex w-full justify-between from-[#003271]  to-[#FFFFFF]">
      ...
      <div className={`md:mt-18 py-10 md:py-0 space-y-4 md:w-1/2 ${poppins.className}`}>
        ...
        <div className="space-y-5 md: px-10 md:px-16">
          <p className="">
            Whether you are looking for trusted professionals or new
            opportunities to grow your business, TaskShift gives you the tools,
            trust, and visibility to make it happen
          </p>
          <p className="">
      ...
      <div className={`${inter.className} md:w-1/2 md:hidden block  px-6 sm:px-12 md:px-18 py-5`}>
        {facts.map((fact) => (
          <div
            key={fact.id}
