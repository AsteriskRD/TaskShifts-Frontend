...
const Footer = () => {
    return (
        <div className="bg-[#24272A]">
            <div className="md:hidden mx-auto w-full px-6 sm:px-12 block py-6">
                <Link href="/">
                    <Image src={logo} alt="logo" width={50} />
                </Link>
            </div>
            <div className="flex justify-between max-w-7xl mx-auto px-6 md:px-0 py-5 bg-[#24272A] gap-4">
            ...
            >
                ...
                <div
                    className={`flex ${poppins.className} text-xs sm:text-sm gap-5 md:gap-10`}
                >
