...
const WantToKnowMore = () => {
  return (
    <div className={`${poppins.className}  py-10 px-8 sm:px-12 md:px-10 `}>
      <div className="md:flex w-full items-center md:gap-20">
        ...
        <div data-aos="flip-left" className="w-full">
          <h1 className="font-bold pt-3 md:py-0 text-2xl">
      ...
      <div data-aos="fade-right" className="md:flex gap-20 justify-betweend w-full">
        <div className="flex flex-col">
          <div className="py-5">
            <button className="bg-[#FF9A63] w-full font-bold py-1.5 px-3">
              Our Mission
            </button>
          </div>
        ...
        <div className="flex flex-col">
          <div className="py-5">
            <button className="bg-[#FF9A63] w-full py-1.5 font-bold px-3">
              Our Vision
            </button>
          </div>
          <p className="text-[#5C5C66]">
